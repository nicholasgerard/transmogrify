...
const PUBLIC_ERROR_MESSAGES = new Map([
  ...
  ['FOREIGN_LAUNCH_AGENT', 'Desktop attachment persistence found a LaunchAgent it does not own'],
  ['FOREIGN_LOGIN_SETTING', 'the Desktop login-session setting differs from the owned persistence receipt'],
  ...
  ['PERSISTENCE_NOT_OWNED', 'Desktop attachment persistence has no valid ownership receipt'],
  ['PERSISTENCE_ROLLBACK_FAILED', 'Desktop attachment persistence failed and its rollback did not complete'],
  ...
  ['RELAY_IDENTITY_UNVERIFIED', 'the recorded relay process identity could not be affirmatively verified'],
  ['RELAY_NOT_OWNED', 'the compatible relay was not launched by this Transmogrify installation'],
  ['RELAY_UNAVAILABLE', 'the selected relay is not listening'],
  ...
  ['RUNTIME_UNSUPPORTED', 'the Codex runtime failed a required compatibility check; run the doctor before retrying'],
